...
def download_slot_file(room_id, player_id: int):
    ...
    if not slot_data:
        ...
        if slot_data.game == "Minecraft":
        ...
        elif slot_data.game == "Factorio" or slot_data.game == "Factorio - Space Age Without Space":
            ...
            fname = f"AP+{app.jinja_env.filters['suuid'](room_id)}_P{slot_data.player_id}_{slot_data.player_name}.apmlss"
