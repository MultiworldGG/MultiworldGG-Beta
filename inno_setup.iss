...
Source: "python_installers\python-3.12.12-amd64.exe"; DestDir: {tmp}; Flags: deleteafterinstall; Check: IsPythonNeeded and IsX64
Source: "python_installers\python-3.12.12-arm64.exe"; DestDir: {tmp}; Flags: deleteafterinstall; Check: IsPythonNeeded and IsARM64
...
Filename: "{tmp}\python-3.12.12-amd64.exe"; Parameters: "/passive InstallAllUsers=1 PrependPath=1 Include_test=0"; Check: IsPythonNeeded and IsX64; StatusMsg: "Installing Python 3.12.12..."
Filename: "{tmp}\python-3.12.12-arm64.exe"; Parameters: "/passive InstallAllUsers=1 PrependPath=1 Include_test=0"; Check: IsPythonNeeded and IsARM64; StatusMsg: "Installing Python 3.12.12..."
...
Root: HKCR; Subkey: "{#MyAppName}cvcotmpatch\DefaultIcon";         ValueData: "{app}\MultiWorldGG.exe,0";                                          ValueType: string; ValueName: "";
Root: HKCR; Subkey: "{#MyAppName}cvcotmpatch\shell\open\command";  ValueData: """{app}\MultiWorldGG.exe"" ""%1""";                                 ValueType: string; ValueName: "";
...
Root: HKCR; Subkey: "{#MyAppName}tlozpatch\DefaultIcon";         ValueData: "{app}\MultiWorldGG.exe,0";                           ValueType: string;  ValueName: "";
Root: HKCR; Subkey: "{#MyAppName}tlozpatch\shell\open\command";  ValueData: """{app}\MultiWorldGG.exe"" ""%1""";                  ValueType: string;  ValueName: "";
...
Root: HKCR; Subkey: "{#MyAppName}apebpatch\DefaultIcon";         ValueData: "{app}\MultiWorldGG.exe,0";                           ValueType: string;  ValueName: "";
Root: HKCR; Subkey: "{#MyAppName}apebpatch\shell\open\command";  ValueData: """{app}\MultiWorldGG.exe"" ""%1""";                  ValueType: string;  ValueName: "";
...
Root: HKCR; Subkey: "{#MyAppName}apsmmrpatch\DefaultIcon";         ValueData: "{app}\MultiWorldGG.exe,0";                           ValueType: string;  ValueName: "";
Root: HKCR; Subkey: "{#MyAppName}apsmmrpatch\shell\open\command";  ValueData: """{app}\MultiWorldGG.exe"" ""%1""";                  ValueType: string;  ValueName: "";
...
Root: HKCR; Subkey: "{#MyAppName}apsmopatch\DefaultIcon";         ValueData: "{app}\MultiWorldGG.exe,0";                      ValueType: string; ValueName: "";
Root: HKCR; Subkey: "{#MyAppName}apsmopatch\shell\open\command";  ValueData: """{app}\MultiWorldGG.exe"" ""%1""";             ValueType: string; ValueName: "";
...
Root: HKCR; Subkey: "{#MyAppName}aptatkpatch\DefaultIcon";         ValueData: "{app}\MultiWorldGG.exe,0";                           ValueType: string;  ValueName: "";
Root: HKCR; Subkey: "{#MyAppName}aptatkpatch\shell\open\command";  ValueData: """{app}\MultiWorldGG.exe"" ""%1""";                  ValueType: string;  ValueName: "";
