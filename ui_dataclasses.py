"""
Data classes shared by every MultiworldGG frontend (Kivy GUI, Textual TUI, ...).

Lives in src/ rather than in any frontend package so importing one of these
types never triggers a Kivy load. mwgg_gui.components.guidataclasses re-exports
