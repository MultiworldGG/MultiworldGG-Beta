...
will unlock checks. Eventually Division 2 (Reverse) will be found and you will gain access to those tournaments, as well as
...
defeating each duelist for the first time will unlock checks. Over time you will unlock more duelists as those checks are found by
by players in the multiworld. Once you've beaten enough duelists, Yami Yugi will be unlocked.
...
Filler checks can either be random dice or shop progression and money.
If bonus item mode is set to Shop, you can collect dice from winning
duels and by buying them from Grandpa's Shop to send checks.
...
Currently, the items are silently added to the player's inventory, which can be seen in the dice pool, Free Duel menu, Tournament menu, or Grandpa's Shop.
