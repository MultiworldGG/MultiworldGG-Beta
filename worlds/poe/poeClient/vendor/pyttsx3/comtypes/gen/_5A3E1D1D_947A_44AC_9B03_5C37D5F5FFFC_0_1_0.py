...
from comtypes import BSTR, CoClass, COMMETHOD, GUID, helpstring
...
typelib_path = 'c:\\Users\\Lindsay\\source\\repos\\MultiworldGG\\src\\worlds\\poe\\poeClient\\vendor\\pyttsx3\\comtypes\\test\\TestComServer.tlb'
...
class ITestComServerEvents(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        def EvalStarted(self, what: hints.Incomplete) -> hints.Hresult: ...
        def EvalCompleted(self, what: hints.Incomplete, result: hints.Incomplete) -> hints.Hresult: ...
...
class ITestComServer(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IDispatch):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def eval(self, what: hints.Incomplete) -> hints.Incomplete: ...
        def do_cy(self, value: hints.Incomplete = ...) -> hints.Hresult: ...
        def do_date(self, value: hints.Incomplete = ...) -> hints.Hresult: ...
        def Exec(self, what: hints.Incomplete) -> hints.Hresult: ...
        def Exec2(self, what: hints.Incomplete) -> hints.Hresult: ...
        def MixedInOut(self, a: hints.Incomplete, c: hints.Incomplete) -> hints.Tuple[hints.Incomplete, hints.Incomplete]: ...


ITestComServer._methods_ = [
    COMMETHOD(
        ['propget', helpstring('returns the id of the server')],
        HRESULT,
        'id',
        (['out', 'retval'], POINTER(c_uint), 'pid')
    ),
    COMMETHOD(
        ['propget', helpstring('the name of the server')],
        HRESULT,
        'name',
        (['out', 'retval'], POINTER(BSTR), 'pname')
    ),
    COMMETHOD(
        ['propput', helpstring('the name of the server')],
        HRESULT,
        'name',
        (['in'], BSTR, 'pname')
    ),
    COMMETHOD(
        [helpstring('a method that receives an BSTR [in] parameter')],
        HRESULT,
        'SetName',
        (['in'], BSTR, 'name')
    ),
    COMMETHOD(
        [helpstring('evaluate an expression and return the result')],
        HRESULT,
        'eval',
        (['in'], BSTR, 'what'),
...
# The size and alignment check for MYCOLOR is skipped.
...
__all__ = [
    'ITestComServerEvents', 'TestComServer', 'ITestComServer',
    'Library', 'MYCOLOR', 'typelib_path'
]
