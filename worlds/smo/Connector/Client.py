        ...
        match cmd:
            ...
            case "ReceivedItems":
                ...
                for item in args["items"]:
                    ...
                    if self.player_data.check_goal(net_item):
                        self.server_msgs.append({"cmd" : "StatusUpdate", "status" : ClientStatus.CLIENT_GOAL})
                        print("Goal achieved")
...
def launch(server_address: str = None, slot_name: str = None, password: str = None, ready_callback=None, error_callback=None):
    ...
    async def main():
        ctx = SMOContext(server_address, slot_name, password, ready_callback, error_callback)
