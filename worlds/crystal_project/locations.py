...
def get_boss_locations(player: int, options: CrystalProjectOptions | None) -> List[LocationData]:
    ...
    location_table: List[LocationData] = [
        ...
        LocationData(SALMON_BAY_BASIN_AP_REGION, SALMON_BAY_DISPLAY_NAME + " Boss - Guaba Summon", 1138 + boss_index_offset, lambda state: state.has(SUMMONER_JOB, player) and logic.is_area_in_level_range(state, GUABA_FIGHT_LEVEL), tags=[SUMMON_LOCATION_GROUP]), #-50, 91, -330 Monster ID: 94
        ...
        #Shadow Master old rule: (logic.has_swimming(state) or logic.has_horizontal_movement(state))
...
def get_shop_locations(player: int, options: CrystalProjectOptions | None) -> List[LocationData]:
    ...
    location_table: List[LocationData] = [
        #Zones (Beginner)
        #Spawning Meadows
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 1", 100013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 2", 200013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 3", 300013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 4", 400013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 5", 500013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 6", 600013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 7", 700013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 8", 800013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 9", 900013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 10", 1000013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 11", 1100013 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Knick Knacks 12", 1200013 + shop_index_offset),

        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Stew 1", 100014 + shop_index_offset),
        LocationData(SPAWNING_MEADOWS_AP_REGION, SPAWNING_MEADOWS_DISPLAY_NAME + " Shop - Nan's Stew 2", 200014 + shop_index_offset),

        #Delende
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Weapon Merchant 1", 100052 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Weapon Merchant 2", 200052 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Weapon Merchant 3", 300052 + shop_index_offset),

        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Armor Merchant 1", 100063 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Armor Merchant 2", 200063 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Armor Merchant 3", 300063 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Armor Merchant 4", 400063 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Armor Merchant 5", 500063 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Armor Merchant 6", 600063 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Armor Merchant 7", 700063 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Armor Merchant 8", 800063 + shop_index_offset),

        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Fish Merchant 1", 100199 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Fish Merchant 2", 200199 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Fish Merchant 3", 300199 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Fish Merchant 4", 400199 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Fish Merchant 5", 500199 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Fish Hatchery Fish Merchant 6", 600199 + shop_index_offset),

        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Weapons Merchant camped in front of Pale Grotto 1", 100115 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Weapons Merchant camped in front of Pale Grotto 2", 200115 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Weapons Merchant camped in front of Pale Grotto 3", 300115 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Weapons Merchant camped in front of Pale Grotto 4", 400115 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Weapons Merchant camped in front of Pale Grotto 5", 500115 + shop_index_offset),

        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Armor Merchant camped in front of Pale Grotto 1", 100446 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Armor Merchant camped in front of Pale Grotto 2", 200446 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Armor Merchant camped in front of Pale Grotto 3", 300446 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Armor Merchant camped in front of Pale Grotto 4", 400446 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Armor Merchant camped in front of Pale Grotto 5", 500446 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Armor Merchant camped in front of Pale Grotto 6", 600446 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Armor Merchant camped in front of Pale Grotto 7", 700446 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Armor Merchant camped in front of Pale Grotto 8", 800446 + shop_index_offset),

        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Item Merchant camped in front of Pale Grotto 1", 100266 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Item Merchant camped in front of Pale Grotto 2", 200266 + shop_index_offset),
        LocationData(DELENDE_PLAINS_AP_REGION, DELENDE_DISPLAY_NAME + " Shop - Item Merchant camped in front of Pale Grotto 3", 300266 + shop_index_offset),

        #Seaside Cliffs
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + " Shop - Camp Merchant 1", 100116 + shop_index_offset),
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + " Shop - Camp Merchant 2", 200116 + shop_index_offset),
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + " Shop - Camp Merchant 3", 300116 + shop_index_offset),
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + " Shop - Camp Merchant 4", 400116 + shop_index_offset),
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + " Shop - Camp Merchant 5", 500116 + shop_index_offset),
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + " Shop - Camp Merchant 6", 600116 + shop_index_offset),
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + " Shop - Camp Merchant 7", 700116 + shop_index_offset),
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + " Shop - Camp Merchant 8", 800116 + shop_index_offset),
        LocationData(SEASIDE_CLIFFS_AP_REGION, SEASIDE_CLIFFS_DISPLAY_NAME + " Shop - Camp Merchant 9", 900116 + shop_index_offset),

        #Mercury Shrine
        LocationData(MERCURY_SHRINE_AP_REGION, MERCURY_SHRINE_DISPLAY_NAME + " Shop - Attendant 1", 100132 + shop_index_offset),
        LocationData(MERCURY_SHRINE_AP_REGION, MERCURY_SHRINE_DISPLAY_NAME + " Shop - Attendant 2", 200132 + shop_index_offset),
        LocationData(MERCURY_SHRINE_AP_REGION, MERCURY_SHRINE_DISPLAY_NAME + " Shop - Attendant 3", 300132 + shop_index_offset),

        #Proving Meadows
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Item Merchant 1", 100253 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Item Merchant 2", 200253 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Item Merchant 3", 300253 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Item Merchant 4", 400253 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Item Merchant 5", 500253 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Item Merchant 6", 600253 + shop_index_offset),

        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 1", 100133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 2", 200133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 3", 300133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 4", 400133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 5", 500133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 6", 600133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 7", 700133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 8", 800133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 9", 900133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 10", 1000133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 11", 1100133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 12", 1200133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 13", 1300133 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Armor Merchant 14", 1400133 + shop_index_offset),

        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 1", 100117 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 2", 200117 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 3", 300117 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 4", 400117 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 5", 500117 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 6", 600117 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 7", 700117 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 8", 800117 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 9", 900117 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Weapon Merchant 10", 1000117 + shop_index_offset),

        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Accessories Merchant 1", 100134 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Accessories Merchant 2", 200134 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Accessories Merchant 3", 300134 + shop_index_offset),
        LocationData(PROVING_MEADOWS_AP_REGION, PROVING_MEADOWS_DISPLAY_NAME + " Shop - Accessories Merchant 4", 400134 + shop_index_offset),

        #Zones (Advanced)
        #Capital Sequoia
        LocationData(CAPITAL_SEQUOIA_AP_REGION, "Gaea Shrine Shop - Attendant 1", 100379 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, "Gaea Shrine Shop - Attendant 2", 200379 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Candy Merchant 1", 100575 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Candy Merchant 2", 200575 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 1", 101158 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 2", 201158 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 3", 301158 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 4", 401158 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 5", 501158 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 6", 601158 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 7", 701158 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 8", 801158 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 9", 901158 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Map Seller 10", 1001158 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Martial Weapons 1", 100599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Martial Weapons 2", 200599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Martial Weapons 3", 300599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Martial Weapons 4", 400599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Martial Weapons 1", 500599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Martial Weapons 2", 600599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Martial Weapons 3", 700599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Martial Weapons 4", 800599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Martial Weapons 5", 900599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Martial Weapons 6", 1000599 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Exotic Weapons 1", 100600 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Exotic Weapons 2", 200600 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Exotic Weapons 3", 300600 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Exotic Weapons 4", 400600 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Exotic Weapons 1", 500600 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Exotic Weapons 2", 600600 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Exotic Weapons 3", 700600 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Exotic Weapons 4", 800600 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Heavy Armor 1", 100601 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Heavy Armor 2", 200601 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Heavy Armor 3", 300601 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Heavy Armor 1", 400601 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Heavy Armor 2", 500601 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Heavy Armor 3", 600601 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Medium Armor 1", 100602 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Medium Armor 2", 200602 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Medium Armor 1", 300602 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Medium Armor 2", 400602 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Magic Weapons 1", 100603 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Magic Weapons 2", 200603 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Magic Weapons 3", 300603 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Magic Weapons 1", 400603 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Magic Weapons 2", 500603 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Magic Weapons 3", 600603 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Light Armor 1", 100604 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Luxury Shop Light Armor 2", 200604 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Light Armor 1", 300604 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Upgraded Luxury Shop Light Armor 2", 400604 + shop_index_offset, lambda state: state.has(PROGRESSIVE_LUXURY_PASS, player, 2), tags=[LUXURY_PASS_LOCATION_GROUP]),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 1", 100500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 2", 200500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 3", 300500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 4", 400500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 5", 500500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 6", 600500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 7", 700500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 8", 800500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 9", 900500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 10", 1000500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 11", 1100500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 12", 1200500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 13", 1300500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 14", 1400500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 15", 1500500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 16", 1600500 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Martial Weapons R Us 17", 1700500 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Exotic Weapons R Us 1", 100501 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Exotic Weapons R Us 2", 200501 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Exotic Weapons R Us 3", 300501 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Exotic Weapons R Us 4", 400501 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Exotic Weapons R Us 5", 500501 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Exotic Weapons R Us 6", 600501 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Milk Man", 100579 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 1", 100416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 2", 200416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 3", 300416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 4", 400416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 5", 500416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 6", 600416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 7", 700416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 8", 800416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 9", 900416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 10", 1000416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 11", 1100416 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Heavy Armor 4 All 12", 1200416 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Medium Armor 4 All 1", 100417 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Medium Armor 4 All 2", 200417 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Medium Armor 4 All 3", 300417 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Medium Armor 4 All 4", 400417 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Medium Armor 4 All 5", 500417 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Medium Armor 4 All 6", 600417 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Medium Armor 4 All 7", 700417 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Medium Armor 4 All 8", 800417 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Medium Armor 4 All 9", 900417 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Light Armor 1", 100455 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Light Armor 2", 200455 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Light Armor 3", 300455 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Light Armor 4", 400455 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Light Armor 5", 500455 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Light Armor 6", 600455 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Light Armor 7", 700455 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Light Armor 8", 800455 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 1", 100499 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 2", 200499 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 3", 300499 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 4", 400499 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 5", 500499 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 6", 600499 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 7", 700499 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 8", 800499 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 9", 900499 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Magic and Magic Things Weapons 10", 1000499 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 1", 100398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 2", 200398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 3", 300398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 4", 400398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 5", 500398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 6", 600398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 7", 700398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 8", 800398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 9", 900398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 10", 1000398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 11", 1100398 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Accessory Merchant 12", 1200398 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Item Merchant 1", 100456 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Item Merchant 2", 200456 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Item Merchant 3", 300456 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Item Merchant 4", 400456 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Item Merchant 5", 500456 + shop_index_offset),
        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Item Merchant 6", 600456 + shop_index_offset),

        LocationData(CAPITAL_SEQUOIA_AP_REGION, CAPITAL_SEQUOIA_DISPLAY_NAME + " Shop - Old Nan's Stew", 100423 + shop_index_offset),

        #Salmon River
        #Poseidon Shrine Proper
        LocationData(POSEIDON_SHRINE_PROPER_AP_REGION, POSEIDON_SHRINE_PROPER_AP_REGION + " Shop - Attendant 1", 100631 + shop_index_offset),
        LocationData(POSEIDON_SHRINE_PROPER_AP_REGION, POSEIDON_SHRINE_PROPER_AP_REGION + " Shop - Attendant 2", 200631 + shop_index_offset),
        LocationData(POSEIDON_SHRINE_PROPER_AP_REGION, POSEIDON_SHRINE_PROPER_AP_REGION + " Shop - Attendant 3", 300631 + shop_index_offset),

        #Sara Sara Bazaar
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Old Nan's Stew Subsidiary", 100957 + shop_index_offset),

        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Accessory Merchant 1", 101386 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Accessory Merchant 2", 201386 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Accessory Merchant 3", 301386 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Accessory Merchant 4", 401386 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Accessory Merchant 5", 501386 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Accessory Merchant 6", 601386 + shop_index_offset),

        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Item Merchant 1", 101193 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Item Merchant 2", 201193 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Item Merchant 3", 301193 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Item Merchant 4", 401193 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Item Merchant 5", 501193 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Item Merchant 6", 601193 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Item Merchant 7", 701193 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Item Merchant 8", 801193 + shop_index_offset),

        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Fish Merchant 1", 100942 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Fish Merchant 2", 200942 + shop_index_offset),

        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Armor Merchant 1", 101603 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Armor Merchant 2", 201603 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Armor Merchant 3", 301603 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Armor Merchant 4", 401603 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Armor Merchant 5", 501603 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Armor Merchant 6", 601603 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Armor Merchant 7", 701603 + shop_index_offset),

        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 1", 101604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 2", 201604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 3", 301604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 4", 401604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 5", 501604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 6", 601604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 7", 701604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 8", 801604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 9", 901604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 10", 1001604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 11", 1101604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 12", 1201604 + shop_index_offset),
        LocationData(SARA_SARA_BAZAAR_AP_REGION, SARA_SARA_BAZAAR_DISPLAY_NAME + " Shop - Weapon Merchant 13", 1301604 + shop_index_offset),

        #Zones (Expert)
        #Shoudu Province
        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Item Merchant 1", 100951 + shop_index_offset),
        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Item Merchant 2", 200951 + shop_index_offset),
        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Item Merchant 3", 300951 + shop_index_offset),
        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Item Merchant 4", 400951 + shop_index_offset),
        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Item Merchant 5", 500951 + shop_index_offset),
        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Item Merchant 6", 600951 + shop_index_offset),
        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Item Merchant 7", 700951 + shop_index_offset),
        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Item Merchant 8", 800951 + shop_index_offset),
        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Item Merchant 9", 900951 + shop_index_offset),

        LocationData(SHOUDU_DOCKSIDE_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - No Shoudu Stew for you 1", 101199 + shop_index_offset),

        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Accessory Merchant 1", 101614 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Accessory Merchant 2", 201614 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Accessory Merchant 3", 301614 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Accessory Merchant 4", 401614 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Accessory Merchant 5", 501614 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Accessory Merchant 6", 601614 + shop_index_offset),

        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 1", 101535 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 2", 201535 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 3", 301535 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 4", 401535 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 5", 501535 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 6", 601535 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 7", 701535 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 8", 801535 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 9", 901535 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Armor Merchant 10", 1001535 + shop_index_offset),

        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 1", 101544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 2", 201544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 3", 301544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 4", 401544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 5", 501544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 6", 601544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 7", 701544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 8", 801544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 9", 901544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 10", 1001544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 11", 1101544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 12", 1201544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 13", 1301544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 14", 1401544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 15", 1501544 + shop_index_offset),
        LocationData(SHOUDU_PROVINCE_PROPER_AP_REGION, SHOUDU_PROVINCE_DISPLAY_NAME + " Shop - Weapon Merchant 16", 1601544 + shop_index_offset),

        #Ganymede Shrine
        LocationData(GANYMEDE_SHRINE_AP_REGION, GANYMEDE_SHRINE_DISPLAY_NAME + " Shop - Attendant 1", 101574 + shop_index_offset),
        LocationData(GANYMEDE_SHRINE_AP_REGION, GANYMEDE_SHRINE_DISPLAY_NAME + " Shop - Attendant 2", 201574 + shop_index_offset),
        LocationData(GANYMEDE_SHRINE_AP_REGION, GANYMEDE_SHRINE_DISPLAY_NAME + " Shop - Attendant 3", 301574 + shop_index_offset),

        #Quintar Reserve
        #Quintar Mausoleum Gift Shop
        LocationData(MAUSOLEUM_GIFT_SHOP_AP_REGION, QUINTAR_RESERVE_DISPLAY_NAME + " Shop - Babel to this Quintar 1", 100470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(MAUSOLEUM_GIFT_SHOP_AP_REGION, QUINTAR_RESERVE_DISPLAY_NAME + " Shop - Babel to this Quintar 2", 200470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(MAUSOLEUM_GIFT_SHOP_AP_REGION, QUINTAR_RESERVE_DISPLAY_NAME + " Shop - Babel to this Quintar 3", 300470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(MAUSOLEUM_GIFT_SHOP_AP_REGION, QUINTAR_RESERVE_DISPLAY_NAME + " Shop - Babel to this Quintar 4", 400470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(MAUSOLEUM_GIFT_SHOP_AP_REGION, QUINTAR_RESERVE_DISPLAY_NAME + " Shop - Babel to this Quintar 5", 500470 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),

        #Dione Shrine
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Attendant 1", 102253 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Attendant 2", 202253 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),

        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Raising Supplies 1", 102227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player), tags=[MOUNT_INSTRUMENT_LOCATION_GROUP]),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Raising Supplies 2", 202227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Raising Supplies 3", 302227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Raising Supplies 4", 402227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Raising Supplies 5", 502227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Raising Supplies 6", 602227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Raising Supplies 7", 702227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Raising Supplies 8", 802227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),
        LocationData(DIONE_SHRINE_AP_REGION, DIONE_SHRINE_DISPLAY_NAME + " Shop - Quintar Raising Supplies 9", 902227 + shop_index_offset, lambda state: state.has(BABEL_QUINTAR, player)),

        #Tall Tall Heights
        LocationData(UPPER_ICE_LAKES_AP_REGION, "Triton Shrine Shop - Attendant 1", 101165 + shop_index_offset),
        LocationData(UPPER_ICE_LAKES_AP_REGION, "Triton Shrine Shop - Attendant 2", 201165 + shop_index_offset),

        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 1", 102746 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 2", 202746 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 3", 302746 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 4", 402746 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 5", 502746 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 6", 602746 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 7", 702746 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 8", 802746 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 9", 902746 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Armor Merchant 10", 1002746 + shop_index_offset),

        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 1", 100540 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 2", 200540 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 3", 300540 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 4", 400540 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 5", 500540 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 6", 600540 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 7", 700540 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 8", 800540 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 9", 900540 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Weapon Merchant 10", 1000540 + shop_index_offset),

        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Souvenir Merchant 1", 102918 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Souvenir Merchant 2", 202918 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Souvenir Merchant 3", 302918 + shop_index_offset),
        LocationData(SOUVENIR_SHOP_AP_REGION, TALL_TALL_HEIGHTS_DISPLAY_NAME + " Shop - Souvenir Merchant 4", 402918 + shop_index_offset),

        #Jidamba Tangle
        LocationData(EUROPA_SHRINE_AP_REGION, EUROPA_SHRINE_AP_REGION + " Shop - Attendant 1", 101163 + shop_index_offset),
        LocationData(EUROPA_SHRINE_AP_REGION, EUROPA_SHRINE_AP_REGION + " Shop - Attendant 2", 201163 + shop_index_offset),

        #Neptune Shrine
        LocationData(NEPTUNE_SHRINE_AP_REGION, NEPTUNE_SHRINE_DISPLAY_NAME + " Shop - Attendant 1", 103164 + shop_index_offset),
        LocationData(NEPTUNE_SHRINE_AP_REGION, NEPTUNE_SHRINE_DISPLAY_NAME + " Shop - Attendant 2", 203164 + shop_index_offset),
        LocationData(NEPTUNE_SHRINE_AP_REGION, NEPTUNE_SHRINE_DISPLAY_NAME + " Shop - Attendant 3", 303164 + shop_index_offset),

        #Zones (End-Game)
        #The New World
        LocationData(THE_NEW_WORLD_AP_REGION, THE_NEW_WORLD_DISPLAY_NAME + " Shrine Shop - Attendant 1", 101877 + shop_index_offset),
        LocationData(THE_NEW_WORLD_AP_REGION, THE_NEW_WORLD_DISPLAY_NAME + " Shrine Shop - Attendant 2", 201877 + shop_index_offset),
    ]
    return location_table
