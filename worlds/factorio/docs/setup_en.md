...
- The generated Factorio Mod, created as a result of running `MultiworldGGGenerate.exe` or downloaded from
- One running instance of the MultiworldGG Client per Factorio world
...
6. Open your MultiworldGG client. Type `/connect <server-address>` into the input box at the bottom of the client and press enter.
...
3. Ensure port `34197` is forwarded to the computer running the MultiworldGG Client. This can be done in your router's settings.
