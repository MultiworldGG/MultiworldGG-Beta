...
class AnimalWellWeb(WebWorld):
    ...
    tutorials = [
        Tutorial(
            ...
            description="A guide to setting up the ANIMAL WELL Randomizer for MultiworldGG multiworld games.",
            language="English",
...
class AnimalWellWorld(World):
    ...
    GAME_NAME, AUTHOR, AP_VERSION, WORLD_VERSION = get_archipelago_json("animal_well")

    game = GAME_NAME
    author = AUTHOR
    
    version_string = WORLD_VERSION
