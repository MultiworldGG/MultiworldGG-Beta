...
<!-- mwgg:bundled-apworld -->
> **MultiworldGG:** If your MultiworldGG release includes this game's APWorld, it is already installed. Skip the separate download and installation of that APWorld below, unless you need a different version. Install the required game mods, patch files, and other dependencies as described below. Other APWorlds mentioned in this guide may have separate requirements.
...
You also need to have [MultiworldGG](https://github.com/MultiworldGG/MultiworldGG/releases/latest) installed
