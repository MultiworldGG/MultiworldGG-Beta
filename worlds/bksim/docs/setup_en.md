...
- [MultiworldGG](https://github.com/MultiworldGG/MultiworldGG/releases/latest), to generate or use text client.
- [BK Simulator](https://emilyv99.itch.io/bk-simulator/purchase)
