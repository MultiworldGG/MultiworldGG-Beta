...
The [player settings page for this game](../player-options) contains all the options you need to configure and export a config file.
...
## What is the goal of Rabi-Ribi in MultiworldGG
