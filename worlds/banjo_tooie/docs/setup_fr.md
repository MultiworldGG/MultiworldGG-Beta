# Guide d'installation pour le randomiseur MultiworldGG de Banjo-Tooie
...
-   Everdrive:
    ...
    -   Pour AP: Téléchargez la version la plus récente du connecteur pour Everdrive: https://github.com/jjjj12212/AP_Banjo-Tooie/releases
...
- Lancez le MultiworldGG Launcher et sélectionnez le client de Banjo-Tooie, dans la colonne de droite.
...
- Dans BizHawk, cliquez sur Tools, suivi de Lua Console. De là, vous pouvez glisser-déposer banjo_tooie_connector.lua (situé dans le dossier data/lua du dossier de MultiworldGG) dans la fenêtre de la Lua console.
