...
- Everdrive:
    ...
    - If you use AP: Grab the latest release of the Everdrive connector from https://github.com/jjjj12212/AP_Banjo-Tooie/releases
...
- If you rather not use **/autostart**:
    ...
    - Once you are in the game title menu or game select screen, drag and drop the connector_bt_bizhawk.lua script (which can be found in the data/lua folder of MultiworldGG) onto the Lua console window
