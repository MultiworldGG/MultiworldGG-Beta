...
def patch_rom(rom_path, dst_path, patch_path):
  ...
  if md5 == "ca0df738ae6a16bfb4b46d3860c159d9": # byte swapped
    ...
    logger.error(f"Unknown ROM! Please use /patch or restart the {apname} Client to try again.")
    return False
...
def launch(server_address: str = None, slot_name: str = None, password: str = None, ready_callback=None, error_callback=None):
    ...
    async def main():
        ctx = BanjoTooieContext(server_address, slot_name, password, ready_callback, error_callback)
