...
misc_collectable_table = {
    ...
    itemName.TREBLE:        ItemData(1230516,  9, "progression_deprioritized_skip_balancing", ""),
    itemName.CHUFFY:        ItemData(1230796,  1, "progress", locationName.CHUFFY),
    itemName.NOTE:          ItemData(1230797, 144, "progression_deprioritized_skip_balancing", ""),
