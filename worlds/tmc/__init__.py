...
class MinishCapWebWorld(WebWorld):
    ...
    tutorials = [
        Tutorial(tutorial_name="Setup Guide",
                 description="A guide to setting up The Legend of Zelda: The Minish Cap for MultiworldGG.",
                 language="English",
...
class MinishCapWorld(World):
    """
    The Legend of Zelda: The Minish Cap is the twelfth entry in The Legend of Zelda series and serves as a prequel to Four Swords and Four Swords Adventures, 
    telling the origins of the titular Four Sword and the villain Vaati. 
