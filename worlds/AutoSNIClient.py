...
__all__ = ["AutoSNIClientRegister", "SNIClient", "SnesReader", "SnesData", "valid_patch_suffix"]

from worlds._sni.client import AutoSNIClientRegister, SNIClient, SnesReader, SnesData, valid_patch_suffix
