...
class AutoSNIClientRegister(abc.ABCMeta):
    ...
    def get_all_games() -> list[str]:
        ...
        return list(AutoSNIClientRegister.game_handlers.keys())

    @staticmethod
    def has_sni_client(game_name: str) -> bool:
        """Check if a specific game has an SNI client registered"""
        return game_name in AutoSNIClientRegister.game_handlers

    @staticmethod
    def is_sni_world(module_name: str) -> bool:
        """Check if a world module has a registered SNI client"""
