...
links_awakening_items = [
    ...
    ItemData(ItemName.RUPEES_20, "RUPEES_20", ItemClassification.skip_balancing),
    ItemData(ItemName.RUPEES_50, "RUPEES_50", ItemClassification.skip_balancing),
    ItemData(ItemName.RUPEES_100, "RUPEES_100", ItemClassification.skip_balancing),
    ItemData(ItemName.RUPEES_200, "RUPEES_200", ItemClassification.skip_balancing),
    ItemData(ItemName.RUPEES_500, "RUPEES_500", ItemClassification.skip_balancing),
    ItemData(ItemName.SEASHELL, "SEASHELL", ItemClassification.progression_deprioritized_skip_balancing),
