...
items: dict[CandyBox2ItemName, CandyBox2ItemData] = {
    CandyBox2ItemName.CANDY: CandyBox2ItemData(candy_box_2_base_id + 0, lambda _: 0, ItemClassification.progression_deprioritized_skip_balancing),
    ...
    CandyBox2ItemName.TWENTY_CANDIES: CandyBox2ItemData(candy_box_2_base_id + 47, lambda _: 1, ItemClassification.progression_deprioritized_skip_balancing),
    CandyBox2ItemName.ONE_HUNDRED_CANDIES: CandyBox2ItemData(candy_box_2_base_id + 48, lambda _: 1, ItemClassification.progression_deprioritized_skip_balancing),
    CandyBox2ItemName.FIVE_HUNDRED_CANDIES: CandyBox2ItemData(candy_box_2_base_id + 49, lambda _: 1, ItemClassification.progression_deprioritized_skip_balancing),
