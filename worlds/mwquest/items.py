...
def get_random_filler_item_name(world: MWQuestWorld) -> str:
    # MWQuest has an option called "trap_chance".
...
def create_item_with_correct_classification(world: MWQuestWorld, name: str) -> MWQuestItem:
    ...
    return MWQuestItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


# With those two helper functions defined, let's now get to actually creating and submitting our itempool.
def create_all_items(world: MWQuestWorld) -> None:
    ...
    # MWQuest has two of these: The Confetti Cannon and the Math Trap.
    ...
    #  Starting here, the word "filler" will be used to collectively refer to MWQuest's Confetti Cannon and Math Trap,
    ...
    # But there is an alternative that works even better for most worlds, including MWQuest.
