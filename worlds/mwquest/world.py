...
from . import options as mwquest_options  # rename due to a name conflict with World.options

# MWQuest will go through all the parts of the world api one step at a time,
...
class MWQuestWorld(World):
    """
    MWQuest is a minimal 8bit-era inspired adventure game with grid-like movement.
    ...
    web = web_world.MWQuestWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "mwquest_options" at the top of this file to avoid a name conflict)
    options_dataclass = mwquest_options.MWQuestOptions
    options: mwquest_options.MWQuestOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.MWQuestItem:
