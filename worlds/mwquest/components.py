...
# MWQuest has a Python client inside the apworld that contains the entire game. This is a component.
# MWQuest will not teach you how to make a client or any other type of component.
# However, let's quickly talk about how you register a component to be launchable from the MultiworldGG Launcher.
...
def run_client(*args: str) -> None:
    ...
    from .client.launch import launch_mw_quest_client
    ...
    # This will create a subprocess for your component, launching it in a separate window from the MultiworldGG Launcher.
    launch(launch_mw_quest_client, name="MWQuest Client", args=args)
...
# As you can see above, the MWQuest client has both of these parameters set.
# This means a user can click on the slot name of an MWQuest slot on WebHost,
# then click "MWQuest Client" instead of "Text Client" in the Launcher popup, and after a few seconds,
