from .bases import MWQuestTestBase


# When writing a test, you'll first need to subclass unittest.TestCase.
# In our case, we'll subclass the MWQuestTestBase we defined in bases.py.
class TestEasyModeLogic(MWQuestTestBase):
    ...
    options = {
        ...
        # All other options in MWQuest are cosmetic, so we don't need to list them.
    }
        ...
        with self.subTest("Test sword is required for enemy and bush locations"):
            ...
            self.assertAccessDependency(
                [
                    ...
                    "Final Boss Defeated",  # Reminder: MWQuest's victory condition uses this event location
                ],
                [["Sword"]],
            )
