...
if TYPE_CHECKING:
    from .world import MWQuestWorld
...
class MWQuestLocation(Location):
    game = "MWQuest"
...
def create_all_locations(world: MWQuestWorld) -> None:
    create_regular_locations(world)
    create_events(world)


def create_regular_locations(world: MWQuestWorld) -> None:
    ...
    bottom_left_chest = MWQuestLocation(
    ...
    bottom_right_room.add_locations(bottom_right_room_locations, MWQuestLocation)

    top_left_room_locations = get_location_names_with_ids(["Top Left Room Chest"])
    top_left_room.add_locations(top_left_room_locations, MWQuestLocation)

    right_room_locations = get_location_names_with_ids(["Right Room Enemy Drop"])
    right_room.add_locations(right_room_locations, MWQuestLocation)
    ...
    if world.options.hammer:
        ...
        top_middle_room.add_locations(top_middle_room_locations, MWQuestLocation)
    else:
        overworld.add_locations(top_middle_room_locations, MWQuestLocation)
    ...
    if world.options.extra_starting_chest:
        ...
        overworld.add_locations(bottom_left_extra_chest, MWQuestLocation)


def create_events(world: MWQuestWorld) -> None:
    ...
    button_in_top_left_room = MWQuestLocation(world.player, "Top Left Room Button", None, top_left_room)
    ...
    button_item = items.MWQuestItem("Top Left Room Button Pressed", ItemClassification.progression, None, world.player)
    ...
    final_boss_room.add_event(
        "Final Boss Defeated", "Victory", location_type=MWQuestLocation, item_type=items.MWQuestItem
    )
