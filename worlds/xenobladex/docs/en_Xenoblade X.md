...
4. Whenever you get equipment via MultiworldGG the traits will be seeded according to the possible
...
MultiworldGG only updates when overworld time is progressing.
...
### Items
All items belong to the following categories:
- CLP = Collectopedia
- SEG = Segments
- EBK = Enemy Book
- FNO = FN-Nodes
- LOC = Locations
Most of the locations contain additional information on where to find it.
They might contain a region of the following categories:
- Prim = Primordia
- Noct = Noctilum
- Obli = Oblivia
- Sylv = Sylvalumn
- Caul = Cauldros
They might contain a required chapter, weather, location or mission.
### Locations
All locations belong to the following categories:
- SKF = Skell Frames (Ares 90, ...)
- FLDSK = Field Skills (Mechanical 2-5, ...)
- ART = Weapon Arts (Sliding Slinger, ...)
- KEY = Most important items (FNet, ...)
- WPN = Weapons
- SKWPN = Skell Weapons
- SKAMR = Skell Armor
- SKL = Skill (Your passives)
- FRD = Friend Levels 1-5
- DP = Dataprobes
- IMPIT = Important Items (Mostly Quest Items)
- AUG = Augments
- AMR = Armor
