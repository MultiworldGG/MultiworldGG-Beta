...
class PaintWebWorld(WebWorld):
    ...
    setup_en = Tutorial(
        ...
        description="A guide to playing Paint in MultiworldGG.",
        language="English",
...
class PaintWorld(World):
    """
    The classic Microsoft app, reimagined as an Archipelago/MWGG game! Find your tools, expand your canvas, and paint the
