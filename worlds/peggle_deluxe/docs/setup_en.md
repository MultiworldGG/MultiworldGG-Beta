...
No manual mod installation or other configuration is required to play Peggle Deluxe with MultiworldGG. The client included with the APWorld does all the work by attaching to the game process and monitoring and manipulating the game state in real-time.

**IMPORTANT**

Once the MultiworldGG client is connected, hooks and patches will be set up in the game's memory. _**If the client is ever closed, Peggle Deluxe will NEED to be restarted before connecting another client**_ for everything to function as expected. If you don't restart the game, the previous hooks and patches will remain installed with no way for the new client to detect and use them.
...
- Open the MultiworldGG Launcher. Find and click _Peggle Deluxe Client_
- Using the _Peggle Deluxe Client_:
  - Enter the room's hostname and port number (e.g. multiworld.gg:54321) in the top box and click Connect
  ...
  - You are now ready to play Peggle Deluxe with MultiworldGG. Make sure to check out the `Peggle Deluxe` tab in the client
