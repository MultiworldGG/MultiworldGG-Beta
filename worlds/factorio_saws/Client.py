...
class FactorioCommandProcessor(ClientCommandProcessor):
    ...
    def _cmd_toggle_send_filter(self) -> None:
...
settings: FactorioSAWSSettings = get_settings().factorio_saws_options
if os.path.samefile(settings.executable, sys.executable):
    selected_executable = settings.executable
    settings.executable = FactorioSAWSSettings.executable  # reset to default
