...
class CCCharlesWeb(WebWorld):
    ...
    setup_en = Tutorial(
        ...
        "A guide to setup Choo-Choo Charles for the MultiworldGG MultiWorld Randomizer.",
        "English",
        "setup_en.md",
        "setup/en",
        ["Yaranorgoth"]
    ...
    setup_fr = Tutorial(
        ...
        "Un guide pour mettre en place Choo-Choo Charles pour le Randomiseur Multiworld MultiworldGG",
        "Français",
        "setup_fr.md",
        "setup/fr",
        ["Yaranorgoth"]
