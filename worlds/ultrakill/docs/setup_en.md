...
5. Host a game, either manually, or by [uploading](/uploads) it to the MultiworldGG website.
...
- `connect [address:port] [player] [password]` - Connect to a MultiworldGG server.
- `disconnect`: Disconnect from a MultiworldGG server.
