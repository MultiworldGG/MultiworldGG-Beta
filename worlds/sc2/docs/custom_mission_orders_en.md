...
You will need to know how to write a YAML before engaging with this feature, and should read the [Archipelago YAML documentation](https://multiworld.gg/tutorial/Archipelago/advanced_settings/en) before continuing here.
