...
class MemeBundleName:
    ...
    error = meme_bundle("Error")
    exhaustion = meme_bundle("Exhaustion")
    fast = meme_bundle("Fast")
    finders_keepers = meme_bundle("Finders Keepers")
