...
carpenter = (Region.carpenter_house,)
alex_house = (Region.alex_house,)
elliott_house = (Region.elliott_house,)
ranch = (Region.ranch,)
mines_dwarf_cave = (LogicRegion.mines_dwarf_cave,)
...
abigail = villager(NPC.abigail, True, pierre_house, Season.fall, universal_loves + abigail_loves, True)
...
caroline = villager(NPC.caroline, False, pierre_house, Season.winter, universal_loves + caroline_loves, True)
...
dwarf = villager(NPC.dwarf, False, mines_dwarf_cave, Season.summer, universal_loves + dwarf_loves, False)
...
pierre = villager(NPC.pierre, False, pierre_house, Season.spring, universal_loves + pierre_loves, True)
...
willy = villager(NPC.willy, False, beach + fish_cabin, Season.summer, universal_loves + willy_loves, True)
