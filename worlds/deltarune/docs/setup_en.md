# DELTARUNE MultiworldGG Setup Guide
...
- Only needed with AP: Universal Tracker APWorld from the [UT Releases Page](https://github.com/FarisTheAncient/Archipelago/releases)
...
Using `Generate Template Options` you can find the default YAML and other presets in `<MultiworldGG folder Path>\Players\Templates` which you can edit to your liking. You can also use the `Option Creator` in the MultiworldGG Launcher but be warned that using `Options Generator` will make it harder to read some of the option descriptions. Otherwise, it works great.

After setting your options to your liking, you can generate a Multiworld by following the [MultiworldGG Setup](/tutorial/Archipelago/setup_en).
...
### OR Patching the game with the MultiworldGG DELTARUNE Client

1. Download the APWorld and place it into archipelago/custom_worlds (Double clicking the APWorld will also work!) (not needed with MWGG)
...
4. Move the `DELTARUNE_PATCH` folder to the root of MultiworldGG folder.

<img width="693" height="680" alt="image" src="https://github.com/user-attachments/assets/e41b1fb9-2ddf-4de4-96fa-77066625e58c" />

If you don't know where that is, you can find your MultiworldGG folder by clicking `Browse Files` in your MultiworldGG launcher.

<img width="795" height="287" alt="image" src="https://github.com/user-attachments/assets/fda6c8de-be13-4066-8be0-b0fc64b99fcc" />

5. **Restart the MultiworldGG Launcher** (Or start the launcher if it's not open yet)

<img width="815" height="108" alt="image" src="https://github.com/user-attachments/assets/efced590-006a-4439-8f77-a60f06889ae3" />

6. Start the DELTARUNE client from your MultiworldGG folder or the Archipelago app.
...
9. Next, go to your MultiworldGG folder. If everything goes according to plan, you will see a folder called `DELTARUNE`.
...
If you are the host, once you have all of the players YAML, use the Generator provided by the MultiworldGG Launcher.
...
If you're not doing a solo multiworld you must upload it to the [MultiworldGG upload page](/uploads) to generate your room.
...
Not required, but you can also open the DELTARUNE Client in the MultiworldGG Launcher to use Text commands. You can also use Universal Tracker features if you have the tracker APWorld installed.
