...
### I've never added a game to AP/MultiworldGG before. Should I start with the APWorld or the game client?
...
- A first-time world developer may or may not be deeply familiar with AP or MultiworldGG, but they're almost certainly familiar
...
MultiworldGG/AP logic assumes that once a region or location becomes reachable, it stays reachable forever, no matter what 
